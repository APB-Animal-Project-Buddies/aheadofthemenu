...
/** Piece 5 — owned-creator summary: a small card linking out to the public page. */
function OwnedSummary({ creator }: { creator: OwnedCreator }) {
  return (
    <div className="mt-3 flex items-center gap-3 rounded-xl border border-neutral-200 bg-white p-4">
      {creator.image_url ? (

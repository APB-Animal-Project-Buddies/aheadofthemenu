...
/**
 * Piece 5 — owned-creator summary card, led by the big "Edit my Creator
 * Profile" CTA (editing is inline on the public page, which nobody discovers
 * on their own, so the button is the front door to it).
 */
